...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    $query = "SELECT * FROM vales ORDER BY id DESC LIMIT 1";
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
        ...
        <section id="about" class="about">
            ...
            <div class="form-group">
                <label style="font-size:18px;">Monto</label>
                <input type="text" name="monto" class="form-control">
            </div>
            <div class="form-group">
                <label style="font-size:18px;">Folio</label>
                <input type="text" name="folio" class="form-control">
            </div>
            <div class="form-group">
                <label style="font-size:18px;">Empresa</label>
                <input type="text" name="empresa" class="form-control">
            </div>
            <div class="form-group">
                <label style="font-size:18px;">Tipo de gasolina</label>
                <input type="text" name="gasolina" class="form-control">
            </div>
            <div class="form-group">
                <label style="font-size:18px;">Vehiculo</label>
                <input type="text" name="vehiculo" class="form-control">
            </div>
            <div class="form-group">
                <label style="font-size:18px;">Ticket</label>
